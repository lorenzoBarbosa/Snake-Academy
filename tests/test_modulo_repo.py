...
class TestModuloRepo:
    ...
    def test_atualizar_modulo(self, test_db):
        ...
        modulo_atualizado = atualizar_modulo_por_id(1, modulo_db)
        # Assert
        assert modulo_atualizado is True, "O módulo não foi atualizado com sucesso"
        modulo_db2 = obter_modulo_por_id(modulo_inserido)
        assert modulo_db2.titulo == "Novo modulo", "O título do módulo está inorreto"
        assert modulo_db2.descricaoModulo == "Nova descrição", "A descrição do módulo está inorreta"
    ...
    def test_obter_modulos_por_curso_paginado(self, test_db):
        ...
        professor= Professor(0, "", "", "", "", "", "", True, [], True, ["python"], 12, "12-06-2025")
        professor_inserido = inserir_professor(professor, cliente_inserido)
        curso_obj1 = Curso(0, "Python1", professor_inserido, 12.99, "não sei", "12:56", "Bom", "12-06-2025", True)
        curso_inserido1 = inserir_curso(curso_obj1)
        curso_obj2 = Curso(0, "Python2", professor_inserido, 15.99, "não sei", "10:00", "Ótimo", "12-06-2025", True)
