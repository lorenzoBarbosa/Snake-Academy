...
class TestComentarioCursoRepo:
    ...
    def test_gerar_comentario_curso(self, test_db):
        ...
        topico_obj = Topico(0, "Python", "12-06-2025")
        topico_inserido = inserir_topico(topico_obj)
        categoria_obj = Categoria(0, "Programação", "12-06-2025")
        categoria_inserida = inserir_categoria(categoria_obj, topico_inserido)
        ...
        matricula_db = obter_matricula_por_id(matricula_inserida)
        #Act
        comentario_curso = comentarioCurso(0, admin_db.id, matricula_db.idMatricula, "Curso horroroso", "12/07/2025", "13/07/2025")
