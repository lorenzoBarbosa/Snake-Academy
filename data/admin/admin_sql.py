...
OBTER_ADMINS = """
SELECT 
    u.id as id, u.nome as nome, u.email as email, u.senha as senha, u.telefone as telefone, u.dataNascimento as dataNascimento, u.perfil as perfil, u.token_redefinicao as token_redefinicao, u.data_token as data_token, u.data_cadastro as data_cadastro, u.foto as foto, a.nivelAcesso
FROM admin a
